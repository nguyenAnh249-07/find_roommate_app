...
class _EditRoomScreenState extends ConsumerState<EditRoomScreen> {
  ...
  Future<void> _loadRoomData() async {
    ...
    if (room != null && mounted) {
      ...
      _allowRoommate = room.allowRoommate;
  ...
  Future<void> _deleteRoom() async {
    ...
    try {
      await FirestoreService().deleteRoom(widget.roomId);
  ...
  Future<void> _hideRoom() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Đã ẩn phòng')),
      );
      Navigator.of(context).pop();
    }
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    _isLoading ? 'Đang cập nhật...' : 'Cập nhật phòng',
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  onPressed: _isLoading ? null : _hideRoom,
